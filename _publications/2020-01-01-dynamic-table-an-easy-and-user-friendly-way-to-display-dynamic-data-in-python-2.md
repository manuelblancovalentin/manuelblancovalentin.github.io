...
permalink: /publication/2020-01-01-dynamic-table-an-easy-and-user-friendly-way-to-display-dynamic-data-in-python-2
date: 2020-01-01
...
```bibtex
@misc{valentin2020dynamic,
    author = "Valentin, Manuel B",
    title = "Dynamic Table: An easy and user-friendly way to display dynamic data in Python",
    journal = "https://github.com/manuelblancovalentin/DynamicTable",
    year = "2020"
}
```
