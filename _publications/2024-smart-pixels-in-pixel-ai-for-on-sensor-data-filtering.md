...
permalink: /publication/2024-smart-pixels-in-pixel-ai-for-on-sensor-data-filtering
...
card_image: '/images/publications/smart_pixels_ben.png'
card_image_alt: 'Smart Pixels: In-pixel AI for on-sensor data filtering.'
---
...
```bibtex
@inproceedings{parpillon2024smart,
    author = "Parpillon, Benjamin and Syal, Chinar and Yoo, Jieun and Swartz, M and Di Guglielmo, G and Bean, A and Berry, D and Valentin, M Blanco and DiPetrillo, K and Badea, A and others",
    title = "Smart Pixels: In-pixel AI for on-sensor data filtering",
