...
permalink: /publication/2020-08-automatic-detection-of-fractures-and-breakouts-patterns-in-acoustic-borehole-image-logs-using-fast-region-convolutional-neural-networks
...
tags: [neural-networks, imaging, geoscience, petrophysics]
...
card_image: '/images/publications/automatic_fractures.png'
card_image_alt: 'Automatic detection of fractures and breakouts patterns in acoustic borehole image logs using fast-region convolutional neural networks.'
---
...
```bibtex
@article{dias2020automatic,
    author = "Dias, Luciana Olivia and Bom, Cl{\'e}cio R and Faria, Elisangela L and Valent{\'\i}n, Manuel Blanco and Correia, Maury Duarte and De Albuquerque, M{\'a}rcio P and De Albuquerque, Marcelo P and Coelho, Juliana M",
    title = "Automatic detection of fractures and breakouts patterns in acoustic borehole image logs using fast-region convolutional neural networks",
